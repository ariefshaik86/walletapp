...
if (isset($_POST['update_password'])) {
    ...
    $userEmail = $_SESSION['email']; // or $_SESSION['user_id'] if using id
    ...
    if ($user && password_verify($currentPassword, $user['password'])) {
        ...
        if ($update->execute([$hashedPassword, $userEmail])) {
...
@media screen and (max-width: 480px) {
 ...
 .profile-box {
    ...
    .message {
      margin-top: 10px;
      font-weight: bold;
      color: <?= strpos($message, 'success') !== false ? 'green' : 'red' ?>;
    }
...
<body>
    ...
    <main class="main-content">
      ...
      <header>
        <div class="header-content">
            <a href="user_dashboard.php" class="logo">WalletApp</a>
  ...
  <div class="actions">
  <span class="link-action" onclick="togglePasswordForm()">Change Password</span>
  <a href="transcations.php" class="link-action">Transactions</a>
  <a href="approval.php" class="link-action">Task Status</a>
  <a href="../logout.php" class="link-action">Logout</a>
</div>

<form method="POST" id="password-form">
  <input type="password" name="current_password" placeholder="Current Password" required>
  <input type="password" name="new_password" placeholder="New Password" required>
  <button type="submit" class="submit-link">Update Password</button>
</form>
