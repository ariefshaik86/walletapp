...
.task-detail-container h1::after {
  content: '';
  position: absolute;
  width: 60%;
  height: 4px;
    ...
    <section class="hero-section">
      <div class="container">
        <div class="hero-content">
          <h1>Earn Money with Tasks</h1>
          <p class="subtitle">Complete simple tasks and get paid directly to your wallet</p>
        </div>
      </div>
    </section>
...
<?php foreach ($tasks as $task): ?>
          <div class="task-card">
            ...
            <div class="task-content">
              <h3 class="task-title"><li><?= htmlspecialchars($task['title']) ?></li></h3>
              <p class="task-description"><li><?= htmlspecialchars($task['description']) ?></li></p>
              <div class="task-meta">
                <span class="task-reward">
                  <i class="fas fa-coins"></i> <li><?= htmlspecialchars($task['cost']) ?>/-</li>
                </span>
              ...
              <div class="task-requirements">
                <span class="requirement"><i class="fas fa-check-circle"></i>follow the steps given in descriptin</span>
              </div>
            </div>
            <a href="../task.php?id=<?= $task['id'] ?>" class="task-btn">Complete Now</a>
          </div>
          <?php endforeach; ?>
</ul>
        </div>
