...
<div id="dashboardContent">
      ...
      <section class="stats-grid">
        <div class="stat-card balance">
          ...
          <div class="stat-info">
            ...
            <h1 class="stat-value" id="walletBalance"><?= htmlspecialchars($wallet)?>.00</h1>
          </div>
          <a href="wallet.php" class="stat-link">View Details <i class="fas fa-arrow-right"></i></a>
        </div>
        ...
        <div class="stat-card earnings">
          ...
          <a href="transcations.php" class="stat-link">View History <i class="fas fa-arrow-right"></i></a>
        </div>
        ...
        <div class="stat-card tasks">
          ...
          <div class="stat-info">
            ...
            <span class="stat-value"><?= htmlspecialchars($availableCount)?></span>
          </div>
          <a href="tasks.php" class="stat-link">View Tasks <i class="fas fa-arrow-right"></i></a>
        </div>
        ...
        <div class="stat-card referrals">
          ...
          <a href="referearn.php" class="stat-link">Invite Friends <i class="fas fa-arrow-right"></i></a>
        </div>
      </section>
      ...
      <section class="tasks-overview">
        <div class="section-header">
          <h2>Task Overview</h2>
          <a href="approval.php" class="view-all">View All <i class="fas fa-chevron-right"></i></a>
        </div>
        ...
        <div class="task-cards">
          <div class="task-card available">
            <div class="task-card-header">
              ...
              <span class="task-count"><?= htmlspecialchars($availableCount)?></span>
            </div>
            <p>Complete tasks to earn money</p>
            <a href="tasks.php" class="task-card-btn">View Tasks</a>
          </div>
          ...
          <div class="task-card pending">
            <div class="task-card-header">
              ...
              <span class="task-count"><?= htmlspecialchars($result['total'])?></span>
            </div>
            <ul class="task-list">
              <?php
       $count = 0;
        ...
        endforeach;
          ...
          <div class="task-card completed">
            <div class="task-card-header">
              ...
              <h3>Completed</h3>
              <span class="task-count"><?=htmlspecialchars($complete['total'])?></span>
            </div>
            <ul class="task-list">
              <?php
       $count = 0;
       foreach ($completedApprovals as $task):
         if ($count >= 3) break;
          ?>
              <li><?= htmlspecialchars($task['task_title'])?></li>
              <?php
      ...
      <section class="recent-activity">
        <div class="section-header">
          ...
          <a href="transcations.php" class="view-all">View All <i class="fas fa-chevron-right"></i></a>
        </div>
         ...
         if ($count >= 3) break;
          ...
          <div class="activity-item">
            ...
            <div class="activity-details">
              ...
              <p>You completed "<?= htmlspecialchars($task['task_title'])?>" task</p>
              <span class="activity-time">2 hours ago</span>
            </div>
            <div class="activity-amount">+ ₹<?= htmlspecialchars($task['reward'])?></div>
          </div>
          <?php
         $count++;
        endforeach;
  ...
  <?php if (count($transactions) > 0): ?>
    <?php foreach ($transactions as $txn): ?>
      <div>
        <?= htmlspecialchars($txn['type']) ?> - ₹<?= htmlspecialchars($txn['amount']) ?> on <?= htmlspecialchars($txn['created_at']) ?>
      </div><hr>
    <?php endforeach; ?>
  <?php else: ?>
