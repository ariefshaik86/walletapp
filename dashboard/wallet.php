...
<body>
  <div class="app-container">
    ...
    <main class="container">
        ...
        <div class="balance-card">
            ...
            <div class="balance-amount">₹<span id="currentBalance"></span><?= htmlspecialchars($wallet)?>.00</div>
            <p>Last updated just now</p>
        </div>

        <!-- Action Buttons -->
        <div class="action-buttons">
            <a  href="withdraw.php"class="btn btn-primary" id="withdrawBtn">
        ...
        <div class="transactions">
            <div class="section-header">
                ...
                <a href="transcations.php" class="view-all">View All</a>
            </div>
  ...
  <nav class="mobile-nav">
    ...
    <a href="#" class="nav-item wallet-btn ">
      <i class="fas fa-wallet"></i>
      <span>Wallet</span>
    </a>
    <a href="withdraw.php" class="nav-item">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (user) {
        ...
        document.getElementById('userFirstName').textContent = user.name ? user.name.split(' ')[0] : 'User';
      }
